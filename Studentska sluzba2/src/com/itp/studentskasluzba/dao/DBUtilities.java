...
public class DBUtilities {
	...
	public void showSQLException(SQLException e) {
		JOptionPane.showMessageDialog(null, "Kod greske: " + e.getErrorCode() + "\nPoruka: " + e.getMessage(),
				"Greska (baza podataka)", JOptionPane.ERROR_MESSAGE);
	}

	public void showErrorMessage(String message) {
		JOptionPane.showMessageDialog(null, message, "Greska (baza podataka)", JOptionPane.ERROR_MESSAGE);
	}
}
